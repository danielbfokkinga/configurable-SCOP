/**
  ...
  * @author Daniel Fokkinga d.b.fokkinga@umail.leidenuniv.nl
  *         
  *         Relevant papers: Stochastic Constraint Propagation for Mining 
  *         Probabilistic Networks, IJCAI 2019
  *         Programming a Stochastic Constraint Optimisation Algorithm, by
  *         Optimisation, DSO workshop at IJCAI 2019
  *
...
object RunnerMaxExp extends App with CPModel {
